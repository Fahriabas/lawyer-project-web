<template>
    <div class="max-w-7xl mx-auto px-4 py-8 grid md:grid-cols-3 gap-6">
      <div class="md:col-span-2">
        <span class="bg-green-700 text-white text-xs font-semibold px-2 py-1 rounded mb-4 inline-block">Artikel</span>
        ...
        <div class="text-sm text-gray-600 mb-6 flex items-center gap-2">
          <span>oleh</span>
          <span class="text-green-700 font-semibold">{{ detailData.author }}</span>
          <span>•</span>
        ...
        <img :src="detailData.image" alt="Article Main Image" class="w-full h-200 object-cover rounded-lg mb-8" />
  
        <div class="prose prose-lg max-w-none text-gray-800 leading-relaxed space-y-4 mb-10">
          <p v-html="detailData.content"></p>
        </div>
  
        <div class="border-t border-b border-gray-200 py-4 flex flex-wrap gap-2 items-center text-sm mb-8">
        ...
        <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-lg mb-8">
          <img :src="detailData.authorAvatar" alt="Author Avatar" class="w-16 h-16 rounded-full object-cover" />
          <div>
            <h4 class="font-bold text-gray-900">{{ detailData.author }}</h4>
            <p class="text-sm text-gray-600">{{ detailData.authorBio }}</p>
            <a href="#" class="text-green-700 text-sm hover:underline">Lihat Artikel Lainnya</a>
          </div>
        </div>
      ...
      <div>
        <div class="bg-gray-100 p-4 rounded">
          <h3 class="text-sm font-bold text-green-700 mb-4">⚡ Terpopuler Sepekan</h3>
          <div v-for="pop in popularPosts" :key="pop.id" class="mb-4 flex gap-3">
            <img :src="pop.thumbnail" class="w-14 h-14 object-cover rounded" />
            <div>
              <p class="text-sm font-semibold text-gray-800 leading-snug">{{ pop.title }}</p>
  ...
  export default {
    ...
    computed: {
      ...
      article() {  
        return {
          id: 1,
          title: 'Akhirnya Saya Tahu Alasan Orang Beli Sepeda Mahal Sampai Ratusan Juta: Gagal Finish, tetapi Setidaknya Gagal Secara Nyaman dan Bermartabat',
          author: 'Mohammad Sadam Husaen',
          date: '22 Juni 2025',
          views: '1.2M',
          comments: '56K',
          image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBcf6G-KVgNeHXodvPp3K0KjyoA29E1LTb2A&s', // Ganti dengan URL gambar relevan
          content: `
      ...
      `,
          ...
          authorAvatar: 'https://www.gravatar.com/avatar/2c7d99fe21a8a25c786a3457a414b512?s=200&d=mp', // Ganti dengan URL avatar penulis
          authorBio: 'Mohammad Sadam Husaen adalah seorang penulis lepas dan penggemar sepeda. Ia gemar menulis tentang gaya hidup, teknologi, dan pengalaman pribadi.',
        };
      },
      ...
      popularPosts() {
        return [
          {
            id: 101,
            title: 'Kualitas Pendidikan Advokat Buruk, Tjoetjoe: Negara Harus Hadir untuk Pembenahan...',
            thumbnail: 'https://www.kai.or.id/wp-content/uploads/2021/01/tjoetjoe-s-hernanto.jpeg',
            date: '19 Juni 2025',
          },
          {
            id: 102,
            title: 'Diduga Ada Unsur Penipuan, RI Siapkan Gugatan Pembatalan Kontrak Satelit di ICC Singapura...',
            thumbnail: 'https://cdn.antaranews.com/cache/1200x800/2025/06/04/1000434809.jpg',
            date: '16 Juni 2025',
          },
          {
            id: 103,
            title: 'Rasanya Jadi Perantau Mengurus KTP...',
            thumbnail: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTHVIbpCvyYYtM1vawuSD3EJDlsbItzF34bw&s',
            date: '16 Juni 2025',
          },
          {
            id: 104,
            title: 'Muslihat Penulisan Ulang Sejarah Mei 1998: Memberikan...',
            thumbnail: 'https://media.istockphoto.com/id/952981694/id/foto/simbol-kota-surabaya-indonesia.jpg?s=612x612&w=0&k=20&c=Vrgm-AxeQlU5vOTaPD7JZUeuLdsLdmBceYilxjPvTAc=',
            date: '15 Juni 2025',
          },
          {
            id: 105,
